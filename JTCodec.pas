...
uses
  ...
  Vcl.Dialogs,
  Core.Utils, Core.Types, Core.ByteReader, Core.BitReader, GSLoader;
...
type
  ...
  protected
    class function Decode(Loader: GSFile): TIntegerList;
    class function DecodeNullCodec(Loader: GSFile; AIntsToRead: Integer): TIntegerList;
    class function DecodeChopper(Loader: GSFile; AValueCount: Integer): TIntegerList;
    class function DecodeMoveToFront(Loader: GSFile): TIntegerList;
    class function GetCodeText(Loader: GSFile; AIntsToRead: Integer): TList<ShortInt>;
    class function ReadCodecType(Loader: GSFile): TCodecType;
    class procedure ReadProbContextsAndOutOfBandValues(Loader: GSFile; ADriver: PCodecDriver);
    class function ReadOutOfBandValues(Loader: GSFile): TIntegerList;
  ...
  public
    class function ReadVecI32(Loader: GSFile; APredictorType: TPredictorType): TIntegerList;
    class function ReadVecU32(Loader: GSFile; APredictorType: TPredictorType): TIntegerList;
  end;

  TArithmeticDecoder = class // v9.5-
    class function Decode(Loader: GSFile; ADriver: PCodecDriver): TIntegerList;
  end;
...
constructor TInt32ProbabilityContextList.Create(Loader: GSFile);
var
  i, j: Integer;
...
class function TIntCDP.ReadVecI32(Loader: GSFile; APredictorType: TPredictorType): TIntegerList;
var
...
class function TIntCDP.ReadVecU32(Loader: GSFile; APredictorType: TPredictorType): TIntegerList;
var
  AIntegerList: TIntegerList;
  i: Integer;
begin
...
class function TIntCDP.Decode(Loader: GSFile): TIntegerList;
var
...
class function TIntCDP.GetCodeText(Loader: GSFile; AIntsToRead: Integer): TList<ShortInt>;
var
  i: Integer;
...
class function TIntCDP.ReadCodecType(Loader: GSFile): TCodecType;
begin
...
class procedure TIntCDP.ReadProbContextsAndOutOfBandValues(Loader: GSFile; ADriver: PCodecDriver);
var
...
class function TIntCDP.ReadOutOfBandValues(Loader: GSFile): TIntegerList;
var
  AValueCount: Integer;
begin
  Result := nil;
...
class function TIntCDP.DecodeNullCodec(Loader: GSFile; AIntsToRead: Integer): TIntegerList;
var
  i: Integer;
begin
  if ((Loader.FileVersion >= 8.0) and (Loader.FileVersion < 9.0)) then
...
class function TIntCDP.DecodeChopper(Loader: GSFile; AValueCount: Integer): TIntegerList;
var
  ChopBits: Integer;
  ValueBias: Integer;
...
class function TIntCDP.DecodeMoveToFront(Loader: GSFile): TIntegerList;
var
...
class function TArithmeticDecoder.Decode(Loader: GSFile; ADriver: PCodecDriver): TIntegerList;
var
...
class function TBitlengthDecoder.Decode(Loader: GSFile; ADriver: PCodecDriver): TIntegerList;
type
...
class function THuffmanDecoder.Decode(Loader: GSFile; ADriver: PCodecDriver): TIntegerList;
var
