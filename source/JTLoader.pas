...
begin
  ...
  begin
    AMesh := TMesh.Create(TVertexTopology.ptTriangleStrip, TShadeMode.smFlat, [asPosition, asNormal]);
  ...
  begin
    ...
    AMesh := TMesh.Create(TVertexTopology.ptTriangles, TShadeMode.smFlat, [asPosition, asNormal]);
  ...
  AMesh.Material := TMaterial.Create;
